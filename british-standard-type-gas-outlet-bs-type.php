...
<html lang="en">
  <head>
    ...
    />
    <title>
      British Standard Type Gas outlet (BS Type)-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
            ...
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-4">
                <div class="product-image-box">
                  <img
                    src="images/British Standard Type Gas outlet.jpg"
              ...
              <div class="col-lg-8">
                ...
                <h3 class="fw-bold mb-3 product-title">British Standard Type Gas outlet (BS Type)</h3>

                <p class="text-secondary">
                Outlets are fixed to the gas source by safety nut preventing non competent personnel to connect the outlet to the wrong gas source. Outlets are manufacturing to precision for dispensing medical gases and vacuum services reliably and safely to the distribution network. One compatible probe is supplied with each gas outlet.
                </p>
