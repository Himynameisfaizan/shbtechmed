...
<html lang="en">
  <head>
    ...
    />
    <title>
      Mechanical ICU Bed (ABS Panels & SS Side Railing) Model - SHB - 1003-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
...
<?php include('header.php');?>
  ...
  <section id="products" class="py-5 bg-white">
            ...
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-4">
                <div class="product-image-box">
                  <img
                    src="images/Mechanical ICU Bed (ABS Panels & SS Side Railing) Model - SHB - 1003.jpg"
    ...
    Mechanical ICU Bed (ABS Panels & SS Side Railing) Model - SHB - 1003
</h3>

<ul class="text-secondary ps-3">
    <li>Overall approx Size: 2100mm x 900mm x 500 - 800 mm</li>
    <li>Frame work made of rectangular M.S. tubes</li>
    <li>Perforated CRC Sheet top in four sections</li>
    <li>Backrest, neerest, Trendelenburg/Reverse Trendelenburg & Hi Low Positions obtained by separate screw from foot end</li>
    <li>Stainless Steel Head & Foot Bows with Laminated Panels</li>
    <li>Aluminium Collapsible Safety side railings</li>
    <li>Provision of Telescopic I.V Rod with 4 locations</li>
    <li>BedMounted on125mm Deluxe Castors, with two brakes</li>
    <li>Pre Treated and Epoxy powder Coated</li>
</ul>
