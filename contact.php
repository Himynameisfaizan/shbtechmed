      ...
      <div class="container py-3">
        <div class="text-center mb-5 reveal-on-scroll">
          <span class="section-badge"
            ><i class="bi bi-chat-dots"></i> Get In Touch</span
          >
          ...
          <div class="col-lg-5 reveal-on-scroll">
            <div class="contact-premium-card">
              ...
              <div class="mb-3 d-flex gap-3 align-items-center">
                ...
                <div>
                  <span class="fw-semibold small text-muted">Mobile</span
                  ><br /><a
              ...
              <div class="mb-3 d-flex gap-3 align-items-center">
                ...
                <div>
                  <span class="fw-semibold small text-muted">Email</span
                  ><br /><a
                    href="mailto:technoshb@gmail.com"
                    class="text-decoration-none text-dark fw-medium"
                    >technoshb@gmail.com</a
                  >
                </div>
              </div>
              <hr />
              <div>
                <p class="mb-1 small">
                  <i class="bi bi-clock-history me-2" style="color: #1e6f9f"></i
                  ><strong>Support hours:</strong> Mon–Sat 9:00 AM – 7:00 PM
                </p>
              </div>
            </div>
          </div>
