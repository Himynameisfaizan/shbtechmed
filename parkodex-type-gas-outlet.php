...
<html lang="en">
  <head>
    ...
    />
    <title>
      Parkodex Type Gas outlet-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
            ...
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-4">
                <div class="product-image-box">
                  <img
                    src="images/Parkodex Type Gas outlet.jpg"
              ...
              <div class="col-lg-8">
                ...
                <h3 class="fw-bold mb-3 product-title">Parkodex Type Gas outlet</h3>

                <p class="text-secondary">
                PARKODEX outlet are design for an easy, quick and safe connection for dispensing medical gases and vacuum services reliably to the secondary device from the distribution network. The flow has been designed to cover all the area of a health care facility.
                </p>
