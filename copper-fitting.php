...
<html lang="en">
  <head>
    ...
    />
    <title>
      Copper Fitting-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
...
<p class="text-secondary">
  Copper Fittings are specially designed for secure and leak-proof
  connections in Medical Gas Pipeline Systems (MGPS). Manufactured from
  high-quality medical-grade copper, these fittings ensure excellent
  durability, corrosion resistance, and reliable gas flow performance in
  critical healthcare environments.

  The fittings are widely used for connecting copper pipelines in hospitals,
  ICUs, operation theatres, and medical gas distribution systems. Their
  precision design allows easy installation, strong sealing, and long service
  life while maintaining high safety and hygiene standards.
</p>
