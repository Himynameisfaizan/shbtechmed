            ...
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-8">
                ...
                <h3 class="fw-bold mb-3 product-title">
                  B.O.D. INCUBATORS DIGITAL
                </h3>

                <p class="text-secondary">
                  Double walled SS 304 chamber with CFC-free cooling. Digital
                  temperature control with PT-100 sensor for precise
                  low-temperature incubation.
                </p>

                <div class="d-flex flex-wrap gap-2 mt-3 mb-4">
                  <span class="spec-badge">
                    <i class="bi bi-thermometer-low me-1"></i>5°C to 60°C
                  </span>

                  <span class="spec-badge">
                    <i class="bi bi-cpu me-1"></i>Digital PID
                  </span>
                </div>
                ...
                <div class="table-responsive product-table">
                  <table class="table table-hover mb-0">
                    ...
                    <tbody>
                      <tr>
                        <td>455 × 410 × 610 mm</td>
                        <td>4.0 Cu.ft</td>
                        <td class="product-highlight">117 Ltrs</td>
                      </tr>

                      <tr>
                        <td>505 × 515 × 830 mm</td>
                        <td>6.1 Cu.ft</td>
                        <td class="product-highlight">171 Ltrs</td>
                      </tr>

                      <tr>
                        <td>570 × 550 × 875 mm</td>
                        <td>10 Cu.ft</td>
                        <td class="product-highlight">280 Ltrs</td>
                      </tr>

                      <tr>
                        <td>650 × 580 × 900 mm</td>
                        <td>12 Cu.ft</td>
                        <td class="product-highlight">336 Ltrs</td>
                      </tr>

                      <tr>
                        <td>700 × 650 × 900 mm</td>
                        <td>15 Cu.ft</td>
                        <td class="product-highlight">420 Ltrs</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
