...
<html lang="en">
  <head>
    ...
    />
    <title>
      Puritan-Bennett Type Gas outlet (PB Type)-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
            ...
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-4">
                <div class="product-image-box">
                  <img
                    src="images/Puritan-Bennett Type Gas outlet (PB Type).jpg"
              ...
              <div class="col-lg-8">
                ...
                <h3 class="fw-bold mb-3 product-title">Puritan-Bennett Type Gas outlet (PB Type)</h3>

                <p class="text-secondary">
                 outlets are manufactured to precision for dispensing medical gases and vacuum services reliably and safely to secondary device from the distribution network and carefully engineered, outlets are safe keeping configuration comply with the provisions of all major standards followed internationally. The flow has been designed to cover all the area of a health care facility.
                </p>
