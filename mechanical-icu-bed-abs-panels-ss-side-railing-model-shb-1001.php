...
<html lang="en">
  <head>
    ...
    />
    <title>
      Mechanical ICU Bed (ABS Panels & SS Side Railing) Model - SHB - 1001-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
...
<?php include('header.php');?>
  ...
  <section id="products" class="py-5 bg-white">
            ...
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-4">
                <div class="product-image-box">
                  <img
                    src="images/Mechanical ICU Bed (ABS Panels & SS Side Railing) Model - SHB - 1001.jpg"
    ...
    Mechanical ICU Bed (ABS Panels & SS Side Railing) Model - SHB - 1001
</h3>

<ul class="text-secondary ps-3">
    <li>Overall approx Size: 2100 mm x 900 mm x 500</li>
    <li>Frame work made of rectangular M.S. tubes</li>
    <li>Perforated CRC Sheet top in four</li>
    <li>Backrest, Kneerest, sections</li>
    <li>Trendelenburg/Reverse800 mm Trendelenburg</li>
    <li>HiLow Positions obtained byseparate screw from foot & end</li>
    <li>e. f. g. h. ABS ABS Moulded Moulded</li>
    <li>Provision of Head & Safety Foot Bows siderailings</li>
    <li>Telescopic I.V Rod with 4 locations</li>
    <li>Bed Mountedon125mm Deluxe Castors, with two brakes</li>
