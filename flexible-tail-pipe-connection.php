...
<html lang="en">
  <head>
    ...
    />
    <title>
      Flexible Tail Pipe Connection-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
...
<?php include('header.php');?>
            ...
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-4">
                <div class="product-image-box">
                  <img
                    src="images/Flexible Tail Pipe Connection.jpg"
  ...
  Flexible Tail Pipe Connection
</h3>

<p class="text-secondary">
  Flexible Tail Pipe Connection is designed for secure and efficient
  connection between gas cylinders and manifold systems in Medical Gas
  Pipeline Systems (MGPS). Manufactured using high-quality stainless steel
  braided flexible hose, it provides excellent durability, pressure
  resistance, and leak-proof performance.

  The connection system is easy to install and ensures smooth gas flow while
  minimizing vibration and stress on the pipeline system. It is widely used
  in hospitals, medical gas manifold rooms, and healthcare facilities for
  reliable oxygen and medical gas supply applications.
</p>
