...
<html lang="en">
  <head>
    ...
    />
    <title>
      MANIFOLD SYSTEM (OXYGEN/N2O)-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
            ...
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-4">
                <div class="product-image-box">
                  <img
                    src="images/AREA ZONAL VALVE BOX.jpg"
              ...
              <div class="col-lg-8">
                ...
                <h3 class="fw-bold mb-3 product-title">MANIFOLD SYSTEM (OXYGEN/N2O)</h3>

                <p class="text-secondary">
                 Area zonal valve box are provided to isolate a section area of hospital to avoid supply interruption to entire establishment in case of emergency, maintenance, repair, periodic testing & planned future expansion. Area zonal valve box are installed in a medical gas pipeline system (MGPS) in all gases including vacuum. This valve box have provision for all gas and vacuum in adding to analog pressure gauge for testing facility emergency supply connection to Medical Gas Alarm System. Valves are horizontally type and MS housing with mat finished quality with window easy to open in case of emergency with top entry connection. This arrangement permit to locate the valve box in area readily accessible to medical restricts unauthorized tempering.
                </p>
<a href="contact.php" class="btn btn-nav-cta ms-lg-3 mt-2 mt-lg-0">
        Get in Touch
      </a>
