...
<html lang="en">
  <head>
    ...
    />
    <title>
     Isolation Ball Valves-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
            ...
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-4">
                <div class="product-image-box">
                  <img
                    src="images/Isolation Ball Valves.jpg"
...
<p class="text-secondary">
  Isolation Ball Valves are designed for safe and efficient control of
  medical gas flow within Medical Gas Pipeline Systems (MGPS). These valves
  allow individual sections of the gas pipeline to be isolated during
  maintenance, emergency situations, or repair work without interrupting the
  complete gas supply system.

  Manufactured using high-quality brass and durable sealing components, the
  valves provide leak-proof operation, smooth performance, and long service
  life. They are widely used in hospitals, ICUs, operation theatres, and
  healthcare facilities to ensure safe and reliable medical gas management.
</p>
