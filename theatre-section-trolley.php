...
<html lang="en">
  <head>
    ...
    />
    <title>
      Theatre Section Trolley-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
...
<?php include('header.php');?>
            ...
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-4">
                <div class="product-image-box">
                  <img
                    src="images/Theatre Section Trolley.jpg"
  ...
  Theatre Section Trolley
</h3>

<p class="text-secondary">
  Theatre Section Trolley is designed for convenient and safe transportation
  of medical gas cylinders and essential equipment within operation theatres
  and hospital environments. Built with a strong and durable framework, the
  trolley ensures smooth mobility, stability, and easy handling during
  critical medical procedures.

  The trolley is equipped with heavy-duty wheels, corrosion-resistant
  finishing, and an ergonomic structure for long-lasting performance. It is
  ideal for use in hospitals, ICUs, emergency wards, and surgical operation
  theatres where reliable movement of medical equipment is essential.
</p>
