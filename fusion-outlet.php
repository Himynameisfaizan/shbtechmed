...
<html lang="en">
  <head>
    ...
    />
    <title>
     Fusion outlet-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
          ...
          <div class="card-body p-4 p-lg-5">
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-8">
                ...
                <h3 class="fw-bold mb-3 product-title">Fusion outlet</h3>
