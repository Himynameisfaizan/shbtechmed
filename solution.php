...
<html lang="en">
  <head>
    ...
    />
    <title>
      Solution - SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
...
<section class="py-5 bg-light">
    <div class="container">
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-4 col-md-6">
                <div class="p-4 bg-white shadow-sm rounded-4 h-100 text-center">
                    <i class="bi bi-camera-video-fill text-danger display-4"></i>
                    <h4 class="mt-3">CCTV Surveillance System</h4>
                    <p>
                        Complete range of CCTV and IP based surveillance
                        solutions for hospitals, industries and commercial
                        establishments.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="p-4 bg-white shadow-sm rounded-4 h-100 text-center">
                    <i class="bi bi-fingerprint text-danger display-4"></i>
                    <h4 class="mt-3">Access Control System</h4>
                    <p>
                        Advanced access control solutions to regulate and
                        monitor entry and exit points securely.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="p-4 bg-white shadow-sm rounded-4 h-100 text-center">
                    <i class="bi bi-person-badge-fill text-danger display-4"></i>
                    <h4 class="mt-3">Biometric System</h4>
                    <p>
                        Reliable biometric attendance and identification
                        systems for healthcare facilities and offices.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="p-4 bg-white shadow-sm rounded-4 h-100 text-center">
                    <i class="bi bi-bell-fill text-danger display-4"></i>
                    <h4 class="mt-3">Fire Alarm System</h4>
                    <p>
                        Early warning fire detection systems designed to
            ...
            <div class="col-lg-4 col-md-6">
                <div class="p-4 bg-white shadow-sm rounded-4 h-100 text-center">
                    <i class="bi bi-shield-exclamation text-danger display-4"></i>
                    <h4 class="mt-3">Intrusion Alarm System</h4>
                    <p>
                        Intelligent intrusion detection solutions to
                        enhance security and threat monitoring.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="p-4 bg-white shadow-sm rounded-4 h-100 text-center">
                    <i class="bi bi-broadcast-pin text-danger display-4"></i>
                    <h4 class="mt-3">Public Address System</h4>
                    <p>
                        Professional public announcement and communication
            ...
            <div class="col-lg-4 col-md-6">
                <div class="p-4 bg-white shadow-sm rounded-4 h-100 text-center">
                    <i class="bi bi-telephone-fill text-danger display-4"></i>
                    <h4 class="mt-3">EPABX System</h4>
                    <p>
                        Modern business communication solutions with
                        efficient call management capabilities.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="p-4 bg-white shadow-sm rounded-4 h-100 text-center">
                    <i class="bi bi-signpost-split-fill text-danger display-4"></i>
                    <h4 class="mt-3">Boom Barrier</h4>
                    <p>
                        Automated vehicle access control barriers for
                        parking and restricted entry zones.
                    </p>
                </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="p-4 bg-white shadow-sm rounded-4 h-100 text-center">
                    <i class="bi bi-grid-3x3-gap-fill text-danger display-4"></i>
                    <h4 class="mt-3">Flap Barrier</h4>
                    <p>
                        Secure pedestrian access management systems for
        ...
        <div class="mt-5">
            ...
            <p>
                Electronic security systems are widely used in hospitals,
                commercial buildings, educational institutions and industrial
                facilities. These systems help improve security, monitor
                activities, control access and provide reliable emergency
                response capabilities.
            </p>

            <p>
                Security solutions such as surveillance, access control,
                fire detection and intrusion monitoring ensure protection
                of assets, employees and visitors while maintaining a safe
                working environment.
            </p>
        </div>
