...
<html lang="en">
  <head>
    ...
    />
    <title>
    BPC Flowmeter with Humidifier Bottle-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
...
<?php include('header.php');?>
            ...
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-4">
                <div class="product-image-box">
                  <img
                    src="images/BPC Flowmeter with Humidifier Bottle.jpg"
  ...
  BPC Flowmeter with Humidifier Bottle
</h3>

<p class="text-secondary">
  BPC Flowmeter with Humidifier Bottle is designed to deliver accurate and
  controlled oxygen flow to patients in hospitals and healthcare facilities.
  The unit is equipped with a transparent humidifier bottle that helps
  moisturize oxygen before delivery, ensuring greater patient comfort during
  oxygen therapy.

  Manufactured using high-quality materials, the flowmeter provides precise
  flow regulation, durability, and reliable performance in critical medical
  environments. It is widely used in ICUs, operation theatres, emergency
  wards, and bedside oxygen delivery systems.
</p>
