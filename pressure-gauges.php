...
<html lang="en">
  <head>
    ...
    />
    <title>
      Pressure Gauges-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
            ...
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-4">
                <div class="product-image-box">
                  <img
                    src="images/Pressure Gauges.jpg"
...
<p class="text-secondary">
  Pressure Gauges are precision instruments designed to monitor and display
  gas pressure accurately within Medical Gas Pipeline Systems (MGPS). These
  gauges help ensure safe and continuous gas flow by providing clear pressure
  readings for oxygen, vacuum, nitrous oxide, and other medical gas systems.

  Manufactured using high-quality materials, the gauges offer durability,
  reliable performance, and easy readability in critical healthcare
  environments. They are widely used in hospitals, manifold systems, ICUs,
  operation theatres, and gas control panels for efficient monitoring and
  safety management.
</p>
