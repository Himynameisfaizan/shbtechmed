...
<html lang="en">
  <head>
    ...
    />
    <title>
      Ward Vacuum Units-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
            ...
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-4">
                <div class="product-image-box">
                  <img
                    src="images/Ward Vacuum Units.jpg"
...
<p class="text-secondary">
  Ward Vacuum Units are specially designed for efficient suction and vacuum
  applications in hospitals and healthcare facilities. These units are used
  to remove fluids, secretions, and unwanted materials during medical
  procedures, ensuring a clean and safe environment for patient care.

  Manufactured with high-quality components, the vacuum units provide
  reliable suction performance, easy operation, and long-lasting durability.
  They are widely installed in hospital wards, ICUs, operation theatres, and
  emergency care units as an essential part of Medical Gas Pipeline Systems
  (MGPS).
</p>
