...
<body>
    ...
    <div class="card border-0  mb-5 reveal-on-scroll product-card">
        <div class="card-body p-4 p-lg-5">
            <div class="row align-items-center g-4">
                ...
                <div class="col-lg-8">
                    ...
                    <h3 class="fw-bold mb-3 product-title">AUTOCLAVE VERTICAL</h3>

                    <p class="text-secondary">
                        Sturdy double walled construction with stainless steel inner
                        chamber and radial locking system. Designed for safe and
                        efficient sterilization in medical and lab environments.
                    </p>

                    <div class="d-flex flex-wrap gap-2 mt-3 mb-4">
                        <span class="spec-badge">
                            <i class="bi bi-shield-check me-1"></i>SS 304 Chamber
                        </span>

                        <span class="spec-badge">
                            <i class="bi bi-water me-1"></i>5–22 PSI
                        </span>

                        <span class="spec-badge">
                            <i class="bi bi-lightning-charge me-1"></i>ISI Heaters
                        </span>
                    </div>
                        ...
                        <table class="table table-hover mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>250 × 450 mm</td>
                                    <td>1.5 KW</td>
                                    <td class="product-highlight">22 Ltr</td>
                                </tr>

                                <tr>
                                    <td>300 × 500 mm</td>
                                    <td>2 KW</td>
                                    <td class="product-highlight">40 Ltr</td>
                                </tr>

                                <tr>
                                    <td>350 × 550 mm</td>
                                    <td>3 KW</td>
                                    <td class="product-highlight">50 Ltr</td>
                                </tr>

                                <tr>
                                    <td>400 × 600 mm</td>
                                    <td>4 KW</td>
                                    <td class="product-highlight">78 Ltr</td>
                                </tr>

                                <tr>
                                    <td>450 × 600 mm</td>
                                    <td>5 KW</td>
                                    <td class="product-highlight">98 Ltr</td>
                                </tr>

                                <tr>
                                    <td>555 × 750 mm</td>
                                    <td>6 KW</td>
                                    <td class="product-highlight">152 Ltr</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
