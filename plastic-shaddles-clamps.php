...
<html lang="en">
  <head>
    ...
    />
    <title>
      Plastic Shaddles & Clamps-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
...
<?php include('header.php');?>
            ...
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-4">
                <div class="product-image-box">
                  <img
                    src="images/Plastic Shaddles & Clamps.jpg"
  ...
  Plastic Shaddles & Clamps
</h3>

<p class="text-secondary">
  Plastic Shaddles & Clamps are designed to provide strong and secure support
  for medical gas pipeline installations in hospitals and healthcare
  facilities. Manufactured using high-quality durable plastic material, they
  ensure proper alignment, stability, and protection of copper pipelines and
  gas distribution systems.

  These fittings are lightweight, corrosion-resistant, and easy to install,
  making them ideal for long-term use in Medical Gas Pipeline Systems (MGPS).
  They help maintain organized pipeline routing while reducing vibration and
  ensuring reliable support for safe medical gas flow.
</p>
