...
<html lang="en">
  <head>
    ...
    />
    <title>
      High Pressure Tubing-SHB Technologies & Medical Systems | Innovation in Healthcare Tech
    </title>
    <link
            ...
            <div class="row align-items-center g-4">
              ...
              <div class="col-lg-4">
                <div class="product-image-box">
                  <img
                    src="images/High Pressure Tubing.jpg"
                    alt="High Pressure Tubing"
...
<p class="text-secondary">
  High Pressure Tubing is specially designed for safe and reliable gas
  transmission in Medical Gas Pipeline Systems (MGPS). Manufactured using
  high-quality materials, the tubing ensures excellent pressure resistance,
  durability, and leak-proof performance for critical healthcare
  applications.

  It is widely used in hospitals, ICUs, operation theatres, and medical
  gas manifold systems where uninterrupted gas flow and safety are
  essential. The tubing is corrosion-resistant, easy to install, and
  compatible with various medical gas systems.
</p>
